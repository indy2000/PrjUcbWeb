...
var _exportData = function ( dt, inOpts )
{
    ...
    for (var i = 0, ien = rows; i < ien; i++) {
        ...
        for (var j = 0; j < columns; j++) {
            ...
            // Add group header
            if (rowGroup_index != null && grouped_array_index == rowGroup_index) {
                ...
                body.push(['<td colspan="' + (columns - 1) + '"><b>' + 'Sem Grupo' + '</b></td>']);
                rowGroupHeader = 'Sem Grupo';
            }
    ...
    var grouped_array_text = config.grouped_array_text;

    if (grouped_array_text == undefined) { //don't run grouping logic if rows aren't grouped
    ...
    for (var i = 0, row_length = body_with_nodes.length; i < row_length; i++) {
        var sGroup = row_data_array[i][grouped_array_text];
